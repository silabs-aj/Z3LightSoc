...
static EmberCommandEntry emberCommandSecurityTestTable[] = {
		emberCommandEntryActionWithDetails("verify-test",runImageVerifyTest,"","",NULL),
};
static EmberCommandEntry emberCommandSecurityTable[] = {
  emberCommandEntrySubMenu("mfg-token", emberCommandSecurityMfgTokenTable, ""),
  emberCommandEntrySubMenu("test",emberCommandSecurityTestTable,""),
  emberCommandEntryTerminator(),
};
